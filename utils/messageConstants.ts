export const signupMessage = (token: string) => `
  ...
  <a href="http://localhost:5173/verify-account/${token}" target="_blank">Click here to verify</a>
`;
...
export const resetPasswordMessage = (token: string) => `
  ...
  <a href="http://localhost:5173/reset-password/${token}" target="_blank">Click here to reset</a>
`;
